...
const TermsAndConditionsReadOnly = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-gray-800 rounded-lg shadow-xl w-full max-w-2xl flex flex-col relative"
...
export default TermsAndConditionsReadOnly;
