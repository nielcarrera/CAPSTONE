  ...
  morning: [
    {
      ...
      notifications: true,
      steps: [
        { id: 1, product: "Gentle Cleanser", note: "Use lukewarm water" },
        { id: 2, product: "Vitamin C Serum", note: "Apply on damp skin" },
        {
          id: 3,
          product: "Moisturizer",
          note: "Wait 2 minutes before next step",
        },
        { id: 4, product: "Sunscreen SPF 50", note: "Reapply every 2 hours" },
      ],
    },
  ],
  night: [
    {
      ...
      notifications: true,
      steps: [
        { id: 1, product: "Oil Cleanser", note: "Double cleansing method" },
        { id: 2, product: "Foam Cleanser", note: "Gentle circular motions" },
        { id: 3, product: "Toner", note: "Pat gently with hands" },
        { id: 4, product: "Retinol Serum", note: "Use every other night" },
        { id: 5, product: "Night Cream", note: "Focus on dry areas" },
      ],
    },
  ],
  custom: [],
